...
This document provides guidance on how to create Lula-Action releases, address release issues, and other helpful tips.
...
- Pre-v1.0.0 release-please is configured to bump minors on breaking changes and patches otherwise. per [release-please-config](https://github.com/defenseunicorns/lula-action/blob/main/release-please-config.json)
